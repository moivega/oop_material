...
###### Be a Purist | Work Offline | Only One Path - Only One Language | Java (Mobile) | El full-stack integra frontend y backend, media ambas tecnologías. Exp: MEAN Stack. | SQL is the safe place. | It all depends...? || NoSQL/SQL with PHP (Frameworks) + JS: Mejor manejo de variables en el front-end.
